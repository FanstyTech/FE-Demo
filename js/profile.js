   ...
   document.querySelectorAll('.show_code').forEach(b => b.onclick = () => {
...
// copy code 
function copy1(even){
  let input=even.target.parentElement.nextElementSibling.nextElementSibling.children[0].textContent
...
`
          ...
          if(!b.nextElementSibling.firstElementChild.className.includes('mine'))
          {
            ...
            var codemi = CodeMirror.fromTextArea(b.nextElementSibling.firstElementChild,{
              mode : 'xml',
              theme: mytheme,
              readOnly: 'true',
              lineNumbers: 'true',
